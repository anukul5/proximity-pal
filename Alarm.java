...
// Set a threshold distance, for example, 1000 meters (1 km)
                float threshold = 1000.0f; // in meters

// Check if distance is less than threshold
                if (distance < threshold) {
                    // Convert distance to meters and format to two decimal places
                    String distanceString = String.format("%.2f meters", distance);
                    // Show distance in meters
                    updateDistance(distanceString);
                } else {
                    // Convert distance to kilometers and format to two decimal places
                    String distanceString = String.format("%.2f km", distance / 1000.0f);
